...
public class TupleDesc implements Serializable {
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        ...
        for(int i=0;i<td2.numFields();i++){
            typeAr[td1.numFields()+i]=td2.items.get(i).fieldType;
            fieldAr[td1.numFields()+i]=td2.items.get(i).fieldName;
        }
    ...
    public boolean equals(Object o) {
        ...
        for(int i=0;i<this.numFields();i++){
            if(temp.items.get(i).fieldType==null)
                return false;
            if(!temp.items.get(i).fieldType.equals(this.items.get(i).fieldType))
                return false;
            if(temp.items.get(i).fieldName==null&&this.items.get(i).fieldName==null)
                continue;
            if(temp.items.get(i).fieldName==null||this.items.get(i).fieldName==null)
                return false;
            if(!temp.items.get(i).fieldName.equals(this.items.get(i).fieldName)){
                return false;
            }
        }
        return true;
